...
class ParentsController extends AbstractController
{
    ...
    {
        return $this->render('admin/parents/ParentsIndex.html.twig', [
            'parents' => $parentsRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_parentss_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin/parents/new.html.twig', [
            'parent' => $parent,
            'form' => $form,
        ]);
    }
